...
OpenBox integrates with [DeepAgents](https://github.com/langchain-ai/deepagents) by wrapping your agent with a middleware layer — your tools and graph logic stay exactly as they are while every action is governed, scored, and auditable.
