...
description: "Already have AI agents running? Add governance in 3 steps without rebuilding: wrap with SDK, apply policies, monitor - done."
...
Having issues? See the **[Troubleshooting Guide](/getting-started/troubleshooting)**.
...
If your session doesn't appear, check that your worker is running and connected to OpenBox. See the **[Troubleshooting Guide](/getting-started/troubleshooting)** for common issues.
...
- **[Temporal Integration Guide](/developer-guide/temporal-integration-guide-python)** — Deep dive into configuration options, HITL approvals, and advanced scenarios
