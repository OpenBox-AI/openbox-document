...
description: "Deploy your first governed AI agent in 5 minutes: Install SDK, register agent, set policies, track compliance - no architecture changes."
...
**[Run the n8n Demo](/getting-started/run-the-n8n-demo)** — Try a fully configured local setup with Docker, Ollama, and a sample workflow.

**[Wrap an Existing Workflow](/getting-started/wrap-an-existing-n8n-workflow)** — Add governance to your own n8n workflow with `govern()`.
