...
- **[How the Integration Works](/developer-guide/temporal-integration-guide-python#how-the-integration-works)** — Understand the single code change that connects your agent to OpenBox
