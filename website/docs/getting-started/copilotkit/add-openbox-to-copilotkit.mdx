...
If your CopilotKit UI lets users approve or reject OpenBox approval requests directly, add the platform/backend values to the server environment for your approval route:
