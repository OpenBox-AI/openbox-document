---
title: OpenBox
description: "What is OpenBox? Runtime governance platform for AI agents. Enforce policies, verify actions, ensure compliance - before execution, not after."
llms_description: What OpenBox is and how it works
...
OpenBox adds a **trust layer** alongside your workflow engine. Currently supports: Temporal, LangChain, LangGraph, CrewAI, Mastra, Deep Agents, CopilotKit, and n8n. Your workflow engine remains the system of record for execution, OpenBox adds trust and visibility.

## Who This Is For

| Team / Role | How they use OpenBox | Business outcome |
|------------|-----------------------|------------------|
| **Security / Trust & Safety** | Define policies and guardrails, review risky behavior, investigate incidents via Audit Log and [Session Replay](/trust-lifecycle/session-replay) | Reduce security risk, shorten incident response time, enforce consistent controls |
...
| **Agent Lineage** | Connect repository changes, runtime DIDs, sessions, and governance snapshots |
| **Proof of Routing** | Record which upstream provider served each prompt, and share one run's evidence as a page a customer can open |

## Start Here

<div className="linear-cards">
  <Link className="linear-card" to="/getting-started">
  ...
  <Link className="linear-card" to="/trust-lifecycle">
    <div className="linear-card__content">
...
<div className="linear-cards">
  <Link className="linear-card" to="/dashboard">
    <div className="linear-card__content">
  ...
  <Link className="linear-card" to="/dashboard/agents">
    <div className="linear-card__content">
  ...
  <Link className="linear-card" to="/dashboard/projects">
    <div className="linear-card__content">
      <h3 className="linear-card__title">Projects</h3>
      <p className="linear-card__description">Connect repositories and trace agents from code changes to governed runtime sessions.</p>
    </div>
    <span className="linear-card__chevron" aria-hidden="true">›</span>
  </Link>
  <Link className="linear-card" to="/approvals">
    <div className="linear-card__content">
  ...
  <Link className="linear-card" to="/developer-guide/temporal-python/sdk-reference">
    <div className="linear-card__content">
  ...
  <Link className="linear-card" to="/administration/compliance-and-audit">
    <div className="linear-card__content">
