...
See **[Extending the Demo Agent](/developer-guide/deep-agents/extending-the-demo)** for a step-by-step guide to adding your own tools and subagents, or the **[Demo Architecture Reference](/developer-guide/deep-agents/demo-architecture)** for the full middleware lifecycle and event flow.
...
1. **[Extending the Demo Agent](/developer-guide/deep-agents/extending-the-demo)** — Add your own tools, subagents, and skills
