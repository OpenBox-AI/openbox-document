...
Add backend variables only if your CopilotKit UI lets users approve or reject OpenBox approval requests directly:
...
import { createOpenBoxGovernanceMiddleware } from "./openbox_governance";
...
import { openBoxCopilotKitAdapter } from "./openbox_governance";
