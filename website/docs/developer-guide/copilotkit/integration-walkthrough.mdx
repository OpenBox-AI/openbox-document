...
These are the credentials for the generic runtime integration. Demo-specific platform/backend variables are only needed by the reference demo's optional approval-decision route.
...
## Part 6: Add An Approval Decision Route
...
The approval client endpoint should match the server route from Part 6, or your app's equivalent approval-decision path.
