...
description: "Govern a CopilotKit app using the LangGraph backend path: wire the runtime, agent middleware, governed tools, approval route, and React rendering."
