...
The integration connects the CopilotKit runtime boundary to OpenBox. The current reference app uses LangGraph as the backend behind CopilotKit. Trust policy, approvals, guardrails, dashboards, and operator workflows live on the OpenBox platform, not inside CopilotKit.
:::

## Recommended Architecture

Use OpenBox above CopilotKit, and use the LangGraph bridge currently supported by the reference app:
...
3. Configure production behavior in [Configuration](/developer-guide/copilotkit/configuration).
