...
Keep Worker registration and interception inside that `OpenBoxPlugin` initializer. See [Governed Sandbox Commands](/developer-guide/temporal-python/governed-sandbox-commands) for the supported composition.
