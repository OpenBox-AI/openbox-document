...
It is conceptually similar to Anthropic's sandbox-runtime; implemented natively without adopting the Node/npm CLI. Additional providers are documented separately.
