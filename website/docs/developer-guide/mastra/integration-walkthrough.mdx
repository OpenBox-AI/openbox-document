...
- **Already wrapped your agent?** Jump to [What the Integration Captures](#what-the-integration-captures).
...
- an OpenBox agent DID and private key if your registered agent requires DID signing
...
5. If DID signing is enabled for the agent, copy the generated DID and private key
6. Keep those credentials for your Mastra runtime
...
# Required only when this OpenBox agent requires DID signing.
...
- successful request authentication when DID signing is enabled
