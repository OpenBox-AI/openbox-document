...
| `receiptRefs()` | Where to fetch the [run receipt](/developer-guide/openrouter/run-receipt) for each finished run. |
...
- **[Proof of Routing](/developer-guide/openrouter/proof-of-routing)** - The concept behind the record
