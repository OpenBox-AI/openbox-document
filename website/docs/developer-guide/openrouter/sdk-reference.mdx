...
Returns the **locator**, not the document, for each finished run. The receipt itself is built in the dashboard: open **Verify → Run Receipt** for the session the locator names — see [Run Receipt](/developer-guide/openrouter/run-receipt).
