...
| Did any call reach a provider? | A run refused before the request was built has no provenance by definition. Its [run receipt](/developer-guide/openrouter/run-receipt) still attests that nothing ran. |
...
- **[Routing Integrity](/developer-guide/openrouter/routing-integrity)** - How the panel counts
- **[Run Receipt](/developer-guide/openrouter/run-receipt)** - What each verification check establishes
