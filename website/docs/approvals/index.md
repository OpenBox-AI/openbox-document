...
2. **[Monitor Sessions](/docs/agents/trust-lifecycle/monitor)** - Review full session context with [Session Replay](/docs/agents/trust-lifecycle/session-replay) before approving or rejecting
